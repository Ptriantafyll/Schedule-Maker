...
def create_doctor_pre_assignment(session: Session, pre_assignment_data: DoctorPreAssignmentCreate) -> DoctorPreAssignmentModel:
    pass


def get_doctor_pre_assignment(session: Session, doctor_id: str) -> list[DoctorPreAssignmentModel]:
    pass
